...
public class PlayPanel extends APanel { // 控制HUD和地图等组件绘制
    ...
    private JLabel ammo = new JLabel("Ammo:");
    private JLabel currentAmmo = new JLabel();
    ...
    public PlayPanel() {
        ...
        hp.setSize(new Dimension(50,30));
        currentHp.setSize(new Dimension(30,30));
        ammo.setSize(new Dimension(50, 30));
        currentAmmo.setSize(new Dimension(30, 30));

        bottom.add(hp);
        bottom.add(currentHp);
        bottom.add(ammo);
        bottom.add(currentAmmo);

        hp.setLocation(0,0);
        currentHp.setLocation(50,0);
        ammo.setLocation(80,0);
        currentAmmo.setLocation(130, 0);
    ...
    public void updateCurrentAmmo() {
        currentAmmo.setText(String.valueOf(5-mapPanel.getGameController().getCustomTank().getCurrentAmmo()) + '/' + '5');
    }

    private class MapPanel extends APanel {
        ...
        public void initialGame() {
            ...
            gameTimer = new Timer(32, e -> {
                ...
                repaint();
                updateCurrentHP(gameController.getCustomTank());
                updateCurrentAmmo();
    ...
    private class HUD extends APanel {
        public HUD() {
